    ...
    <div className="relative flex h-[calc(100vh_-_theme(spacing.16))] overflow-hidden pb-10 flex-col justify-center items-center">
      ...
      >
        <Typography variant="caption" sx={{ whiteSpace: 'pre-wrap' }}>
          ...
          <ul>
            <li>
              This tool is designed to help you practice and enhance your speaking skills through realistic client interactions. It provides a safe environment to refine your communication approach, handle objections, and improve your persuasive techniques, tailored to various speaking scenarios and audience profiles.
            </li>
            <li>
